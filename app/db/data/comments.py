commentData = [
    ...
    ("The financial forecast document lacks a logical flow, with revenue projections, expenses, and profit margins presented in a disjointed manner.", "Todd Hoover", 7),
    ...
    ("The absence of clear visualizations or graphics detracts from the report's effectiveness in conveying complex project data and trends.", "Martha Robertson", 9),
